# all commented code, seems to work all good, test2 is its version to test K1 and KEY for all KEYs
...
def printDiffPS(DS):
    print("----------------------------------------------------------------------------")
    print("Column Header is the value of input difference delta X and the values in")
    print("the column are all possible output differences delta Y given that delta X.")
    print("----------------------------------------------------------------------------")
    print(DS)
...
if __name__ == '__main__':
    ...
    for i in range(1024):
        ...
        # # =======Comment below to avoid printing # Difference Pair Table and Difference Distribution Table========
        # print()
        # diffPair()
        # diffTab()
        ...
        #     for dey in range(0,3):
        #         for dex2 in range(6,16):
        #             for dey2 in range(0,3):
        for x in DiffList:
            dex = x[0][0]
            dey = x[0][1]
            dex2 = x[1][0]
            dey2 = x[1][1]
            if (dex == 0 or dex2 == 0 or dey == 0 or dey2 == 0):
                continue
            bv_dex = makeBV(dex, 4)
            bv_dey = makeBV(dey, 2)
        ...
        print()
        if guessed_KEY == KEY and guessed_key1 == K1 and makeBV(guessed_key2, 8) == K2:
            match += 1
